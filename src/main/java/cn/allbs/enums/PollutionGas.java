...
@Getter
@AllArgsConstructor
public enum PollutionGas {

    /**
     * 废气
     */
    a00000("废气", "B02", "立方米/秒", "立方米", "N6.1"),
    a01001("温度", "--", "摄氏度", "摄氏度", "N3.1"),
    a01002("湿度", "--", "%", "%", "N3.1"),
    a01006("气压", "--", "千帕", "千帕", "N5.3"),
    a01007("风速", "--", "米/秒", "米/秒", "N4.1"),
    a01008("风向", "--", "度", "[角]度", "N4"),
    a01010("林格曼黑度", "37", "无量纲", "无量纲", "N1"),
    a01011("烟气流速", "S02", "米/秒", "米/秒", "N5.2"),
    a01012("烟气温度", "S03", "摄氏度", "摄氏度", "N3.1"),
    a01013("烟气压力", "S08", "千帕", "千帕", "N5.3"),
    a01014("烟气湿度", "S05", "%", "%", "N3.1"),
    a01015("制冷温度", "S06", "摄氏度", "摄氏度", "N3.1"),
    a01016("烟道截面积", "S07", "平方米", "平方米", "N4.2"),
    a01017("烟气动压", "S04", "千帕", "千帕", "N5.3"),
